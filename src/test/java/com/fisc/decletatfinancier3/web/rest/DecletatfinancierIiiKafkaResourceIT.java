...
import com.fisc.decletatfinancier3.DecletatfinancierIiiApp;
...
@SpringBootTest(classes = DecletatfinancierIiiApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DecletatfinancierIiiKafkaResourceIT {
    ...
    @Autowired
    private DecletatfinancierIiiKafkaProducer producer;

    @Autowired
    private DecletatfinancierIiiKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DecletatfinancierIiiKafkaResource kafkaResource = new DecletatfinancierIiiKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-iii-kafka/publish?message=test"))
