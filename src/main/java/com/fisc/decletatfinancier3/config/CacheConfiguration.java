package com.fisc.decletatfinancier3.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("decletatfinancierIII");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("decletatfinancierIII");
        ...
        config.getMapConfigs().put("com.fisc.decletatfinancier3.domain.*", initializeDomainMapConfig(jHipsterProperties));
